...
const serverErrorEn: Record<string, string> = {
  ...
  "打印机未连接芯烨云，请检查打印机网络后重试": "Printer is disconnected from the cloud. Check its network before retrying.",
  "打印服务响应超时，结果未确认，请先核对是否出纸": "Print service timed out. Check for a printout before retrying.",
  "打印服务连接中断，结果未确认，请先核对是否出纸": "Print service connection was interrupted. Check for a printout before retrying.",
  "打印结果未确认，请先核对是否出纸，勿重复打印": "Print result is unconfirmed. Check for a printout; do not submit it again.",
