...
const pairs: Pair[] = [
  ...
  { zh: "免费早餐", en: "Complimentary Breakfast" },
  { zh: "早餐加点", en: "Breakfast Add-ons" },
  { zh: "早餐饮料", en: "Breakfast Beverages" },
  ...
  { zh: "时令海鲜", en: "Seasonal Seafood" },
  { zh: "本地渔获", en: "Local Catch" },
  { zh: "海味珍馐", en: "Treasures from the Sea" },
  { zh: "石斑鱼", en: "Grouper" },
  { zh: "带鱼", en: "Hairtail" },
  { zh: "青衣鱼", en: "Parrot Fish" },
  { zh: "金玉蟹", en: "Crab" },
  { zh: "富贵虾", en: "Mantis" },
  { zh: "老虎虾", en: "Tiger Prawn" },
  { zh: "开胃菜", en: "Appetizer" },
  { zh: "意面", en: "Pasta" },
  { zh: "米饭", en: "Rice" },
